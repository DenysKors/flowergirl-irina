...
import { getSuppliesByCode } from "@/lib/api";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const suppliesCode = Number(id);
  const supplies: Product = await getSuppliesByCode(suppliesCode);
  ...
  return {
    title: `${supplies.title} / Flowergirl-irina`,
  };
}
