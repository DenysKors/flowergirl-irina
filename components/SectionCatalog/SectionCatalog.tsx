  ...
  return (
    <section className="container py-5">
      <div className="flex flex-col md:flex-row gap-4 md:gap-8 justify-self-center">
        <Link
          className="basis-[33.33%] flex flex-col"
          href={userLinkMap.flowers}
        >
          <div className="overflow-hidden">
            <Image
              className="transition-[transform] duration-300 ease hover:transform-[scale(1.1)]"
              src={PlantsImg}
          ...
          <div className="p-1 md:p-3 max-w-[384px] flex items-center justify-center grow bg-main">
            <h2 className="font-text lg:text-xl text-background text-center">
              Каталог рослин
            </h2>
          </div>
        </Link>
